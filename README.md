...
3. Submit the report [here](https://github.com/ramonclaudio/perplexity-ai-toolkit/issues).
...
3. Submit the request [here](https://github.com/ramonclaudio/perplexity-ai-toolkit/issues).
